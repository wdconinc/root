...
#
get_filename_component(filename "/home/wdconinc/git/root/build-wasm/builtins/LZMA-prefix/src/xz-5.8.2.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/wdconinc/git/root/build-wasm/builtins/LZMA-prefix/src/BUILTIN_LZMA" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-BUILTIN_LZMA${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-BUILTIN_LZMA${i}")
