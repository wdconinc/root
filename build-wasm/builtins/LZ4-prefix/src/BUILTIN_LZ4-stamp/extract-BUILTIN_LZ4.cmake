...
#
get_filename_component(filename "/home/wdconinc/git/root/build-wasm/builtins/LZ4-prefix/src/lz4-1.10.0.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/wdconinc/git/root/build-wasm/builtins/LZ4-prefix/src/BUILTIN_LZ4" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-BUILTIN_LZ4${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-BUILTIN_LZ4${i}")
