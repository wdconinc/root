...
#
get_filename_component(filename "/home/wdconinc/git/root/build-wasm/builtins/ZSTD-prefix/src/zstd-1.5.7.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/wdconinc/git/root/build-wasm/builtins/ZSTD-prefix/src/BUILTIN_ZSTD" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-BUILTIN_ZSTD${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-BUILTIN_ZSTD${i}")
