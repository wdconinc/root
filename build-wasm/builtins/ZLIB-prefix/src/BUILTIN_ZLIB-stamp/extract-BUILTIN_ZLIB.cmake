...
#
get_filename_component(filename "/home/wdconinc/git/root/build-wasm/builtins/ZLIB-prefix/src/zlib-1.3.2.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/wdconinc/git/root/build-wasm/builtins/ZLIB-prefix/src/BUILTIN_ZLIB" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-BUILTIN_ZLIB${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-BUILTIN_ZLIB${i}")
