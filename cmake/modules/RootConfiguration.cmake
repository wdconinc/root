...
if (CMAKE_CXX_COMPILER_ID STREQUAL "NVHPC")
   ...
   try_compile(has__cplusplus "${PROJECT_BINARY_DIR}" SOURCES "${PROJECT_SOURCE_DIR}/config/__cplusplus.cxx"
...
if(MSVC)
  string(REPLACE "-I${PROJECT_SOURCE_DIR}/cmake/win" "" __cxxflags "${__cxxflags}")
  string(REPLACE "-I${PROJECT_SOURCE_DIR}/cmake/win" "" __cflags "${__cflags}")
endif()
...
# ROOT configured for use from the build tree - absolute paths are used.
set(ROOT_CMAKE_DIR ${PROJECT_SOURCE_DIR}/cmake)
")
...
if(WIN32)
  ...
  execute_process(COMMAND ${PROJECT_SOURCE_DIR}/cmake/unix/compiledata.sh
...
configure_file(${PROJECT_SOURCE_DIR}/config/rootssh ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/rootssh @ONLY NEWLINE_STYLE UNIX)
if(WIN32)
  if(thisroot_scripts)
    configure_file(${PROJECT_SOURCE_DIR}/config/thisroot.bat ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/thisroot.bat @ONLY)
  ...
  configure_file(${PROJECT_SOURCE_DIR}/config/root-manifest.xml.in ${PROJECT_BINARY_DIR}/etc/root-manifest.xml @ONLY)
  install(FILES ${PROJECT_SOURCE_DIR}/cmake/win/w32pragma.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR} COMPONENT headers)
  install(FILES ${PROJECT_SOURCE_DIR}/cmake/win/sehmap.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR} COMPONENT headers)
endif()
